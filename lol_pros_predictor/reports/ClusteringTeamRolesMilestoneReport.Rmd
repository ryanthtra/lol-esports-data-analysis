...
Therefore, we can accumulate these match IDs by repeating step 1, and then copying and pasting the IDs into a CSV file, in which portion of the NA LCS 2018 Spring Split is shown in table form in Figure 5.
...
Below is the R script/code used to obtain the top-level match data for the few matches of the NA LCS 2018 Spring Split season.
...
kable(nalcs_season_player_avgs[1:20, 2:10], caption = "Sample of Per Game Player Averages, NA LCS 2018 Spring Split")
```
